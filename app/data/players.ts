// Datos ficticios de jugadores y generador de puntuaciones. Placeholder temporal
// hasta que exista una base de datos real — ver specs/01-mvp-pantallas-vault.md.
